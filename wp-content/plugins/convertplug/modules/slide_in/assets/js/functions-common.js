...
function cp_ckeditors_setup(data) {
	...
	if(jQuery("#main_title_editor").length !== 0 && CKEDITOR.instances.main_title_editor !== undefined ) {
	...
	if(jQuery("#desc_editor").length !== 0) {
		if( slidein_short_desc !== "" && typeof slidein_short_desc !== "undefined" && CKEDITOR.instances.desc_editor !== undefined ){
	...
	if(jQuery("#info_editor").length !== 0) {
		if( slidein_confidential !== "" && typeof slidein_confidential !== "undefined" && jQuery("#info_editor").length !== 0 && CKEDITOR.instances.info_editor !== undefined ){
	...
	if(jQuery("#description_bottom").length !== 0 && CKEDITOR.instances.description_bottom !== undefined ) {
