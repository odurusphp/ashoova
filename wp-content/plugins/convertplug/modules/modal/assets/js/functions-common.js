...
function cp_ckeditors_setup(data) {
	...
	if( typeof data.modal_short_title !== 'undefined' ) {
		...
		if( jQuery("#short_title_editor").length && CKEDITOR.instances.short_title_editor !== undefined ) {
	...
	if( typeof data.modal_note_1 !== 'undefined' ) {
		...
		if( jQuery("#modal_note_1").length && CKEDITOR.instances.modal_note_1 !== undefined ) {
	...
	if( typeof data.modal_note_2 !== 'undefined' ) {
		...
		if( jQuery("#modal_note_2").length && CKEDITOR.instances.modal_note_2 !== undefined ) {
