...
function cp_ckeditors_setup(data) {
	...
	cp_title.html(title);
	if(jQuery("#title_editor").length !== 0 && CKEDITOR.instances.title_editor !== undefined) {
	...
	if(jQuery("#description_editor").length !== 0 && CKEDITOR.instances.description_editor !== undefined ) {
	...
	if(jQuery("#ib_content_editor").length !== 0 && CKEDITOR.instances.ib_content_editor !== undefined ) {
	...
	if(jQuery("#sec_button_editor").length !== 0 && CKEDITOR.instances.sec_button_editor !== undefined ) {
